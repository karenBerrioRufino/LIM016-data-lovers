...
import {computeData, sortData, computeDataTwo} from "./data.js";
...
/* let tableMedalsGold = document.getElementById("MainPage");
let medalsGold = computeData(datos.athletes,"Gold");
for ( let i=0; i< medalsGold.length; i++){
  let tableMedals = document.createElement ("td");
  tableMedals.value = medalsGold[i]; 
  tableMedals.innerHTML = medalsGold[i];
  tableMedalsGold.medal.appendChild(tableMedals)
}
 */
...
//console.log (computeData(datos.athletes));
